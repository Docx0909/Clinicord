...
export class Page4Component implements OnInit {
  ...
  async showclient(id: any) {
    ...
    this.Doctor_id = id;
    try {
      this.ds.processData('getclientondoctor', { id: id }).subscribe((res: any) => {
  ...
  async getappointmentclient(id: any) {
    this.Client_id = id;
    try {
      this.ds.processData('getappointmentdate', { id: id, doctorId: this.Doctor_id }).subscribe((res: any) => {
  ...
  async getappointmentdate(id: any) {
    this.Date = id;
    try {
      this.ds.processData('getappointmenttime', { id: this.Client_id, doctorId: this.Doctor_id, date: this.Date }).subscribe((res: any) => {
        console.log(res.data)
  ...
  async submitPdf(event: any) {
    ...
    try {
      this.ds.formData('sendemailattachment', formData).subscribe((res: any) => {
        if(res.success){
          Swal.fire({
